      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/users/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Content.user() instead.
            "::get::Content::user": {
              url: urlBase + "/contents/:id/user",
              method: "GET",
            },

            // INTERNAL. Use Collection.user() instead.
            "::get::Collection::user": {
              url: urlBase + "/collections/:id/user",
              method: "GET",
            },

            // INTERNAL. Use File.user() instead.
            "::get::File::user": {
     ...
     */
        ...
        R.categoryChild.destroyAll = function() {
          ...
          return action.apply(R, arguments);
             ...
             *  - `id` – `{*}` - PersistedModel id
             *
             *  - `fk` – `{*}` - Foreign key for categoryChild
             *
             * @param {function(Object,Object)=} successCb
             *   Success callback with two arguments: `value`, `responseHeaders`.
             *
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/contents/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Content.collection() instead.
            "prototype$__get__collection": {
              url: urlBase + "/contents/:id/collection",
              method: "GET",
            },

            // INTERNAL. Use Content.audios() instead.
            "prototype$__get__audios": {
              url: urlBase + "/contents/:id/audios",
              method: "GET",
            },

            // INTERNAL. Use Content.audios.create() instead.
            "prototype$__create__audios": {
              url: urlBase + "/contents/:id/audios",
              method: "POST",
            },

            // INTERNAL. Use Content.audios.update() instead.
            "prototype$__update__audios": {
              url: urlBase + "/contents/:id/audios",
              method: "PUT",
            },

            // INTERNAL. Use Content.audios.destroy() instead.
            "prototype$__destroy__audios": {
              url: urlBase + "/contents/:id/audios",
              method: "DELETE",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.Content#search
             * @methodOf lbServices.Content
             *
             * @description
             *
             ...
             */
            "search": {
              url: urlBase + "/contents/search",
              method: "GET",
            },

            // INTERNAL. Use Collection.contents.findById() instead.
            "::findById::Collection::contents": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/collections/:id/contents/:fk",
              method: "GET",
            },

            // INTERNAL. Use Collection.contents.destroyById() instead.
            "::destroyById::Collection::contents": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/collections/:id/contents/:fk",
            ...
            // INTERNAL. Use Collection.contents.updateById() instead.
            "::updateById::Collection::contents": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/collections/:id/contents/:fk",
            ...
            // INTERNAL. Use Collection.contents() instead.
            "::get::Collection::contents": {
              isArray: true,
              url: urlBase + "/collections/:id/contents",
              method: "GET",
            },

            // INTERNAL. Use Collection.contents.create() instead.
            "::create::Collection::contents": {
              url: urlBase + "/collections/:id/contents",
              method: "POST",
            },

            // INTERNAL. Use Collection.contents.createMany() instead.
            "::createMany::Collection::contents": {
              isArray: true,
              url: urlBase + "/collections/:id/contents",
              method: "POST",
            },

            // INTERNAL. Use Collection.contents.destroyAll() instead.
            "::delete::Collection::contents": {
              url: urlBase + "/collections/:id/contents",
              method: "DELETE",
            },

            // INTERNAL. Use Collection.contents.count() instead.
            "::count::Collection::contents": {
              url: urlBase + "/collections/:id/contents/count",
              method: "GET",
            },

            // INTERNAL. Use Audio.content() instead.
            "::get::Audio::content": {
              url: urlBase + "/audios/:id/content",
              method: "GET",
            },
          }
        );
        ...
        */
        ...
        R.user = function() {
          ...
          var action = TargetResource["::get::Content::user"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Content#collection
             * @methodOf lbServices.Content
             *
             * @description
             *
             * Fetches belongsTo relation collection.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.collection = function() {
          var TargetResource = $injector.get("Collection");
          var action = TargetResource["::get::Content::collection"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Content.audios
     * @header lbServices.Content.audios
     * @object
     * @description
     *
     * The object `Content.audios` groups methods
     * manipulating `Audio` instances related to `Content`.
     *
     * Call {@link lbServices.Content#audios Content.audios()}
     * to query all related instances.
     */
             ...
             * @description
             *
             * Fetches hasOne relation audios.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             */
        R.audios = function() {
          var TargetResource = $injector.get("Audio");
          var action = TargetResource["::get::Content::audios"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Content.audios#create
             * @methodOf lbServices.Content.audios
             *
             * @description
             *
             * Creates a new instance in audios of this model.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * </em>
             */
        R.audios.create = function() {
          var TargetResource = $injector.get("Audio");
          var action = TargetResource["::create::Content::audios"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Content.audios#createMany
             * @methodOf lbServices.Content.audios
             *
             * @description
             *
             ...
             * </em>
             */
        R.audios.createMany = function() {
          var TargetResource = $injector.get("Audio");
          var action = TargetResource["::createMany::Content::audios"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Content.audios#destroy
             * @methodOf lbServices.Content.audios
             *
             * @description
             *
             * Deletes audios of this model.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * This method returns no data.
             */
        R.audios.destroy = function() {
          var TargetResource = $injector.get("Audio");
          var action = TargetResource["::destroy::Content::audios"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Content.audios#update
             * @methodOf lbServices.Content.audios
             *
             * @description
             *
             * Update audios of this model.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * </em>
             */
        R.audios.update = function() {
          var TargetResource = $injector.get("Audio");
          var action = TargetResource["::update::Content::audios"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Collection
 * @header lbServices.Collection
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Collection` model.
 *
 * ## Example
 *
 * See
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/collections/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#create
             * @methodOf lbServices.Collection
             *
             * @description
             *
             * Create a new instance of the model and persist it into the data source.
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#createMany
             * @methodOf lbServices.Collection
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#upsert
             * @methodOf lbServices.Collection
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#exists
             * @methodOf lbServices.Collection
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#findById
             * @methodOf lbServices.Collection
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#find
             * @methodOf lbServices.Collection
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#findOne
             * @methodOf lbServices.Collection
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#updateAll
             * @methodOf lbServices.Collection
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#deleteById
             * @methodOf lbServices.Collection
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#count
             * @methodOf lbServices.Collection
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#prototype$updateAttributes
             * @methodOf lbServices.Collection
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#createChangeStream
             * @methodOf lbServices.Collection
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#updateAllContents
             * @methodOf lbServices.Collection
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#updateOrCreate
             * @methodOf lbServices.Collection
             *
             * @description
             *
        ...
        R["updateOrCreate"] = R["upsert"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#update
             * @methodOf lbServices.Collection
             *
             * @description
             *
        ...
        R["update"] = R["updateAll"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#destroyById
             * @methodOf lbServices.Collection
             *
             * @description
             *
        ...
        R["destroyById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#removeById
             * @methodOf lbServices.Collection
             *
             * @description
             *
        ...
        /**
        * @ngdoc property
        * @name lbServices.Collection#modelName
        * @propertyOf lbServices.Collection
        * @description
        * The name of the model represented by this $resource,
        * i.e. `Collection`.
        */
        R.modelName = "Collection";
            ...
            /**
             * @ngdoc method
             * @name lbServices.Collection#user
             * @methodOf lbServices.Collection
             *
             * @description
             *
        ...
        R.user = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::get::Collection::user"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Collection.contents
     * @header lbServices.Collection.contents
     * @object
     * @description
     *
     * The object `Collection.contents` groups methods
     * manipulating `Content` instances related to `Collection`.
     *
     * Call {@link lbServices.Collection#contents Collection.contents()}
     * to query all related instances.
     */
             ...
             * @description
             *
             * Queries contents of collection.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.contents = function() {
          ...
          var action = TargetResource["::get::Collection::contents"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Collection.contents#count
             * @methodOf lbServices.Collection.contents
             *
             * @description
             *
             * Counts contents of collection.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.contents.count = function() {
          var TargetResource = $injector.get("Content");
          var action = TargetResource["::count::Collection::contents"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Collection.contents#create
             * @methodOf lbServices.Collection.contents
             *
             * @description
             *
        ...
        R.contents.create = function() {
          var TargetResource = $injector.get("Content");
          var action = TargetResource["::create::Collection::contents"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Collection.contents#createMany
             * @methodOf lbServices.Collection.contents
             *
             * @description
             *
        ...
        R.contents.createMany = function() {
          var TargetResource = $injector.get("Content");
          var action = TargetResource["::createMany::Collection::contents"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Collection.contents#destroyAll
             * @methodOf lbServices.Collection.contents
             *
             * @description
             *
        ...
        R.contents.destroyAll = function() {
          var TargetResource = $injector.get("Content");
          var action = TargetResource["::delete::Collection::contents"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Collection.contents#destroyById
             * @methodOf lbServices.Collection.contents
             *
             * @description
             *
        ...
        R.contents.destroyById = function() {
          var TargetResource = $injector.get("Content");
          var action = TargetResource["::destroyById::Collection::contents"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Collection.contents#findById
             * @methodOf lbServices.Collection.contents
             *
             * @description
             *
        ...
        R.contents.findById = function() {
          var TargetResource = $injector.get("Content");
          var action = TargetResource["::findById::Collection::contents"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Collection.contents#updateById
             * @methodOf lbServices.Collection.contents
             *
             * @description
             *
        ...
        R.contents.updateById = function() {
          var TargetResource = $injector.get("Content");
          var action = TargetResource["::updateById::Collection::contents"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/audios/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Content.audios.create() instead.
            "::create::Content::audios": {
              url: urlBase + "/contents/:id/audios",
              method: "POST",
            },

            // INTERNAL. Use Content.audios.createMany() instead.
            "::createMany::Content::audios": {
              isArray: true,
              url: urlBase + "/contents/:id/audios",
              method: "POST",
            },
            ...
            // INTERNAL. Use Content.audios.update() instead.
            "::update::Content::audios": {
              url: urlBase + "/contents/:id/audios",
              method: "PUT",
            },

            // INTERNAL. Use Content.audios.destroy() instead.
            "::destroy::Content::audios": {
              url: urlBase + "/contents/:id/audios",
              method: "DELETE",
            },
          }
        ...
        */
        ...
        R.content = function() {
          var TargetResource = $injector.get("Content");
          var action = TargetResource["::get::Audio::content"];
          return action.apply(R, arguments);
        };
    ...
    [
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        */
        ...
        R.user = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::get::File::user"];
          return action.apply(R, arguments);
        };
